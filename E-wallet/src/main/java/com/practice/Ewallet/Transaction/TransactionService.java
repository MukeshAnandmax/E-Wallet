...
import com.practice.Ewallet.User.User;
import com.practice.Ewallet.Wallet.WalletRequest;
import com.practice.Ewallet.notification.EmailRequest;
import com.practice.Ewallet.notification.EmailService;
...
//        User toUser = restTemplate.exchange(uri, HttpMethod.GET, httpEntity,User.class).getBody();
    ...
    public void updateTransaction(String request) throws JsonProcessingException {
        ...
        emailRequest.setMessage(String.format("Hi %s Your transactionId %s got %s . Sent %s money to %s ",
